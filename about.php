    ...
    <div class="overflow-hidden space" id="about-sec">
        ...
        <div class="container">
            <div class="row gy-4 align-items-center">
                <div class="col-xl-6 p-3 position-relative">
                    <div class="about-shape1-1 position-absolute jump">
                        <img src="assets/img/shape/about_shape1_1.png" alt="img">
                    </div>
                    <div class="about-img-bordered position-relative">
                        <img src="assets/img/about/DSC_1352.jpg" alt="About" style="border-radius: 26px;">
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="about-wrap1">
                        <div class="title-area mb-30">
                            <span class="sub-title before-none">About Us Ogeri Health Foundation</span>
                            <h2 class="sec-title">We Believe that We can Save More Lives with you</h2>
                            <p class="">The OGERI Health Foundation is committed to improving health and empowering communities across Africa, starting with our impactful initiatives in Nigeria. Through health education, disease prevention, and innovative healthcare programs, we strive to address critical health challenges and create lasting change. Our journey began in Southeastern Nigeria, where we launched community outreach programs focused on blood pressure screenings, health education, and empowering individuals to take control of their health.</p>
                        </div>
                        <div class="checklist style2 list-two-column" >
                            <h5><i class="fas fa-bullseye"></i> Our Mission</h5>
                            <p>To improve health outcomes and empower communities across Africa, starting in Nigeria, by providing accessible healthcare solutions, advancing health education, and promoting preventive care to build healthier and self-reliant futures for all.</p>
                        </div>

                        <div class="checklist style2 list-two-column">
                            <h5><i class="fas fa-eye"></i> Our Vision</h5>
                            <p>A world where every individual has the knowledge, resources, and support to take control of their health, fostering empowered communities and healthier generations.</p>
                        </div>
...
==============================-->
    <section class="mb-4">
        <div class="container">
            <span class="sub-title before-none">Our Core Values</span>
            <h2 class="sec-title">Guiding Principles that Drive Our Mission</h2>
            <div class="row gy-4 justify-content-center">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="feature-card">
                        ...
                        <div class="box-icon">
                            <img src="assets/img/about/trustworthiness.png" alt="icon">
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="feature-card">
                        ...
                        <div class="box-icon">
                            <img src="assets/img/about/generous.png" alt="icon">
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="feature-card">
                        ...
                        <div class="box-icon">
                            <img src="assets/img/about/first-aid.png" alt="icon">
                        </div>
...
Team Area  
==============================-->
    <section class="space mt-5" id="team-sec" data-bg-src="assets/img/bg/gray-bg2.png">
        ...
        <div class="container">
            <div class="title-area text-center">
                <span class="sub-title after-none before-none"><i class="far fa-heart text-theme"></i> Our Leaders</span>
                <h2 class="sec-title">Meet The Brillant Leaders</h2>
            </div>
            <div class="slider-area">
                <div class="swiper th-slider has-shadow" id="teamSlider3" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"2"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"3"},"1200":{"slidesPerView":"4"}}}'>
                    <div
                        class="swiper-wrapper swiper-wrapper-2">
                        <!-- Single Item -->
                        <div class="swiper-slide">
                            <div class="th-team team-card3">
                                <div class="team-img team-img-about">
                                    <img src="assets/img/ogeri_img/ogerihealthCEO.jpg" alt="Team">
                                </div>
                                <div class="team-card-content">
                                    <h3 class="box-title"><a href="team-details.html">Dr. Oby Enwo </a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="th-team team-card3">
                                <div class="team-img team-img-about">
                                    <img src="assets/img/ogeri_img/ogerihealthTeam2.jpg" alt="Team">
                                </div>
                                <div class="team-card-content">
                                    <h3 class="box-title"><a href="team-details.html">Dr Joseph Ekuma Irem</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="th-team team-card3">
                                <div class="team-img team-img-about">
                                    <img src="assets/img/ogeri_img/ogerihealthTeam3.jpg" alt="Team">
                                </div>
                                <div class="team-card-content">
                                    <h3 class="box-title"><a href="team-details.html">Otu Irem</a></h3>
                                    <span class="team-desig">Outreach Coordinatorr</span>
                                    <div class="th-social style2">
                                        <!-- <a target="_blank" href="https://facebook.com/"><i class="fab fa-facebook-f"></i></a> -->
                                        <!-- <a target="_blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a> -->
                                        <!-- <a target="_blank" href="https://instagram.com/"><i class="fab fa-instagram"></i></a> -->
                        ...
                        <!-- <div class="swiper-slide">
                            <div class="th-team team-card3">
                                ...
                                <div class="team-card-content">
                                    ...
                                    <span class="team-desig">Head of Logistics</span>
                                    <div class="th-social style2">
                                        <a target="_blank" href="https://facebook.com/"><i class="fab fa-facebook-f"></i></a>
                                        <a target="_blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                                        <a target="_blank" href="https://instagram.com/"><i class="fab fa-instagram"></i></a>
                        ...
                        <!-- <div class="swiper-slide">
                            <div class="th-team team-card3">
                                <div class="team-img team-img-about">
                                    <img src="assets/img/about/woman2.jpg" alt="Team">
                                </div>
                                <div class="team-card-content">
                        ...
                        <!-- <div class="swiper-slide">
                            <div class="th-team team-card3">
                                ...
                                <div class="team-card-content">
                                    ...
                                    <span class="team-desig">Chief Medical Officer</span>
                                    <div class="th-social style2">
                                        <a target="_blank" href="https://facebook.com/"><i class="fab fa-facebook-f"></i></a>
                                        <a target="_blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                                        <a target="_blank" href="https://instagram.com/"><i class="fab fa-instagram"></i></a>
...
==============================-->
    <section class="space-top">
        <div class="shape-mockup process-shape1-1 jump-reverse d-xxl-block d-none" data-top="20%" data-left="0"><img src="assets/img/about/work-process-hand.png" alt="img"></div>
        <div class="container">
            <div class="title-area text-center">
                    ...
                    <div class="process-card">
                        <div class="process-card-thumb-wrap">
                            <div class="process-card-thumb" data-mask-src="assets/img/process/process-card-shape.png">
                                <img src="assets/img/about/process-card-1-1.png" alt="img">
                            </div>
    ...
    <div class="space-bottom overflow-hidden brand-area-1">
        <div class="container">
            <div class="brand-wrap1 p-0 m-0 text-center">
                <h3 class="brand-wrap-title">Trusted by over <span class="text-theme2"><span class="counter-number">90</span>K+</span> organizations worldwide</h3>
