  ...
  <!-- <div class="preloader ">
        ...
        <div class="preloader-inner">
            <span class="loader">
                OHF
                <span class="loading-text">OHF</span>
            </span>
        </div>
    </div> -->
  ...
  <div class="th-menu-wrapper">
        <div class="th-menu-area text-center">
            ...
            <div class="mobile-logo">
                <a href="index.php"><img src="assets/img/name-logo.svg" alt="OHF"></a>
            </div>
            <div class="th-mobile-menu">
                <ul>
                    ...
                    <li class="menu-item-has-children mt-2 p-2">
                            ...
                            <div class="info-card">
                                <div class="col-auto header-social-col">
                                    <div class="th-social">
                                        ...
                                        <a href="https://www.instagram.com/ogerihealth/"><i class="fab fa-youtube"></i></a>
                ...
                <div class="menu-area">
                    <div class="menu-area-wrap">
                        <div class="col-auto d-inline-block d-lg-none">
                            <div class="header-logo">
                                <a href="index.php"><img src="assets/img/name-logo.svg" alt="Ohf" class="headerlogo"></a>
                            </div>
                        </div>
                    ...
                    <div class=" main-menu ms-5">
                        <ul>
                        <!-- <a href="contact.html" class="th-btn style3 d-lg-block d-none"> -->
                            <li class="menu-item-has-children th-btn style3 d-lg-block d-none py-2">
                                <a href="#">Get involved</a>
                                <ul class="sub-menu">
                                    <li><a href="donation.php">Donations</a></li>
                                    <li><a href="community-member.php">Community Members</a></li>
