    ...
    <section class="volunteer-section">
      ...
      >
        <div class="volunteer-card">
          <img
            src="./assets/img/volunteer/img/volunteer-avatar-0.png"
        ...
        <div class="volunteer-card">
          <img
            src="./assets/img/volunteer/img/volunteer-avatar-2.png"
            alt="image of a volunteer"
            class="volunteer-avatar"
          />
          <h3>Jason Smith</h3>
        ...
        <div class="volunteer-card">
          <img
            src="./assets/img/volunteer/img/volunteer-avatar-1.png"
            alt="image of a volunteer"
            class="volunteer-avatar"
          />
          <h3>Jason Smith</h3>
        ...
        <div class="volunteer-card">
          <img
            src="./assets/img/volunteer/img/volunteer-avatar-3.png"
            alt="image of a volunteer"
            class="volunteer-avatar"
          />
          <h3>Jason Smith</h3>
      ...
      <div id="testimonialCarousel" class="carousel slide">
        <div class="carousel-indicators c-indicator">
          <button
            ...
            data-bs-slide-to="0"
            class="active indicator-btn l-btn test-indicator"
            aria-current="true"
            aria-label="Slide 1"
          ></button>
          <button
            ...
            data-bs-slide-to="1"
            aria-label="Slide 2"
            class="indicator-btn test-indicator"
          ></button>
          <button
            type="button"
            data-bs-target="#testimonialCarousel"
            data-bs-slide-to="2"
            aria-label="Slide 3"
            class="indicator-btn r-btn test-indicator"
          ></button>
        </div>
        <div class="carousel-inner">
          <div class="carousel-item active">
      ...
      <div class="form-container">
        ...
        <div class="mb-3">
          <select
            ...
            name="profesion"
          >
            <option selected>Select Volunteer Role</option>
        ...
        <div class="mb-3">
          ...
          <div class="file-input-wrapper resumeWrapper">
            <input type="file" class="form-control" id="resume" hidden />
