...
<body>
    ...
    <section id="hero-section">
        ...
        <div id="hero-words">
            ...
            <p class="text-white">
                We run monthly health outreaches that deliver basic care and clear, culturally rooted health education for older adults.
     ...
     data-aos-delay="200"/>
            ...
            <div id="get-involved" class="d-flex flex-column flex-md-row gap-2">
                ...
                <div class="get-involved middle ">
                    ...
                    <h3 class="left-heading2 donate-heading text-white">Become A Volunteer</h3>
                    <p class="left-para donate-para">
        ...
        <div class="right w-100 w-md-50 mb-5 mt-5 mt-md-0" id="donation">
            <div id="top">
